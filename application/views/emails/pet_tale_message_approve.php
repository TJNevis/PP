<html>
	...
	<table cellpadding="0" width="100%" cellspacing="0"><tr><td bgcolor="#d4e6f6">
			...
			<table cellpadding="0" cellspacing="0" width="518">				<tr>
				<tr>
					<td style="font-family:verdana, san-serif;padding:30px 20px; font-size:16px; color:#5689bc;">
						A new message has been posted and <br />is awating your approval on<br>
				...
				<tr>
					<td bgcolor="#ffffff" style="font-family:verdana, san-serif;padding:30px; background-color:#ffffff; font-size:18px; color:#0b5784;">
						...
						<a style="font-weight:bold;font-size:17px; color:#5689bc; margin-top:5px;" href="<?php echo $url."/owner/"?>">Login to approve or deny this message.</a>
					</td>
				</tr>
				<tr>
					<td>
		...
		<br />
		<span style="font-size:11px;font-family:verdana, san-serif; color:#366b9f;"><a style="color:#366b9f;" title="Sender Info" href="<?php echo $url;?>">Sender Info</a><br />
		<span style="font-size:11px;font-family:verdana, san-serif; color:#366b9f;">This email was sent to you because you are the owner of this pet tale.</span><br /><br />
		</center>
		</td></tr></table>
	</body>
</html>
