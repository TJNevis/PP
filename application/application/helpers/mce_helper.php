<?php 
function mce($name,$value,$mode='simple') {
	$ret=<<<EOF
	...
	<script type="text/javascript">
		tinyMCE.init({
		        ...
		        theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,|,image,|,code,removeformat",
	...
	<textarea class="mce" id="$name" name="$name">$value</textarea>
EOF;
	return $ret;
}
?>